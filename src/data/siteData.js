export const site = {
  "dir": "moldremediationfrederick",
  "domain": "moldremediationfrederick.com",
  "title": "Mold Remediation Frederick",
  "business": "Mold Remediation Frederick",
  "phone": "(240) 555-0199",
  ...
  "plural": "remediation plans",
  "proof": [
    "Containment-first process",
    "Moisture-source diagnosis",
    "Basement and attic specialists",
  ...
  "families": [
    {
      ...
      "shortDescription": "Mold Inspection & Testing for Frederick properties with clear planning, careful workmanship, and local service context.",
      "keyPoints": [
        "Frederick-specific mold inspection & testing planning",
    ...
    {
      "slug": "mold-removal-remediation",
      "name": "Mold Removal & Remediation",
      "shortDescription": "Mold Removal & Remediation for Frederick properties with clear planning, careful workmanship, and local service context.",
      "keyPoints": [
        "Frederick-specific mold removal & remediation planning",
        "Clear estimates and staged scheduling",
        "Clean, documented completion standards"
      ],
      "overview": [
    ...
    {
      "slug": "water-moisture-solutions",
      "name": "Water & Moisture Solutions",
      "shortDescription": "Water & Moisture Solutions for Frederick properties with clear planning, careful workmanship, and local service context.",
      "keyPoints": [
        "Frederick-specific water & moisture solutions planning",
        "Clear estimates and staged scheduling",
        "Clean, documented completion standards"
      ],
      "overview": [
    ...
    {
      "slug": "property-specific-remediation",
      "name": "Property-Specific Remediation",
      "shortDescription": "Property-Specific Remediation for Frederick properties with clear planning, careful workmanship, and local service context.",
      "keyPoints": [
        "Frederick-specific property-specific remediation planning",
        "Clear estimates and staged scheduling",
        "Clean, documented completion standards"
      ],
      "overview": [
    ...
    {
      "slug": "prevention-restoration",
      "name": "Prevention & Restoration",
      "shortDescription": "Prevention & Restoration for Frederick properties with clear planning, careful workmanship, and local service context.",
      "keyPoints": [
        "Frederick-specific prevention & restoration planning",
        "Clear estimates and staged scheduling",
        "Clean, documented completion standards"
      ],
      "overview": [
